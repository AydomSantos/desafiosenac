                        ...
                        <form method="POST" class="needs-validation" novalidate>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="idioma" name="idioma" required>
                                    <option value="pt" <?= manter_valor('idioma') === 'pt' ? 'selected' : '' ?>>Português</option>
                                    <option value="en" <?= manter_valor('idioma') === 'en' ? 'selected' : '' ?>>English</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="tema" name="tema" required>
                                    <option value="claro" <?= manter_valor('tema') === 'claro' ? 'selected' : '' ?>>Claro</option>
                                    <option value="escuro" <?= manter_valor('tema') === 'escuro' ? 'selected' : '' ?>>Escuro</option>
                                </select>
                            </div>
